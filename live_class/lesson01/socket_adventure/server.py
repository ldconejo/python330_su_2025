    ...
    * self.room: one of 0, 1, 2, 3. This signifies which "room" the client is in,
    ...
    def room_description(self, room_number):
        ...
        room_descriptions = {
            ...
            1: "This room has white wallpaper.",
            2: "This room has a green floor!",
            3: "This room has a red ceiling!",
            4: "This room has a blue door!",
        }
    ...
    def move(self, argument):
        ...
        * "west"
        ...
        room_moves = {
            0: {'north': 1, 'south': 2, 'east': 3, 'west': 4},
            1: {'south': 0},
            2: {'north': 0},
            3: {'west': 0},
            4: {'east': 0}
        ...
        if direction in room_moves[self.room]:
            new_room = room_moves[self.room].get(direction)
    ...
    def route(self):
        ...
        if self.input_buffer.startswith("move "):
            direction = self.input_buffer.split(" ", 1)[1]
            self.move(direction)
        elif self.input_buffer.startswith("say "):
            message = self.input_buffer.split(" ", 1)[1]
            self.say(message)
