...
# from .models import Show --> First serializer
from .models import Show, Platform, Genre # Final version

from rest_framework.exceptions import NotFound # Added when implementing final version of the file
